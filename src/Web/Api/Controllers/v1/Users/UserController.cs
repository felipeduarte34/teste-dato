using TesteBackend.Api.Controllers.v1.Users.Requests;
using TesteBackend.ApiFramework.Tools;
using TesteBackend.Application.Users.Command.CreateUser;
using TesteBackend.Application.Users.Command.Login;
using TesteBackend.Application.Users.Command.RefreshToken;
using Mapster;
...
namespace TesteBackend.Api.Controllers.v1.Users
{
    [ApiVersion("1")]
