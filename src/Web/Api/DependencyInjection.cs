    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddSwaggerOptions(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "TesteBackend.WebUI",
                    Description = "Teste Backend - Datlo",
                    Contact = new OpenApiContact
                    {
                        Name = "Felipe Machado",
                        Email = "felipe.duarte.machado@gmail.com",
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "TesteBackend.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "TesteBackend.WebUI v2");
